package com.example.myapp16cloud
...
import com.example.myapp16cloud.data.Task
import com.example.myapp16cloud.data.TaskAdapter
import com.example.myapp16cloud.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadTasks() {
        tasks.add(
            com.example.myapp16cloud.data.Task(
                "1",
                "Buy groceries",
                isCompleted = false,
                assignedTo = "Alice"
